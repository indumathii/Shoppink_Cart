...
function App() {
  ...
  const [contextvalues, setcontextvalues] = useState(() => {
    ...
    return savedState ? JSON.parse(savedState) : defaultvalues; // Directly use default values if localStorage is empty
  });
  ...
  return (
    <Router>
      <Context.Provider value={{ contextvalues, setcontextvalues }}>
        {
          console.log("inside app.jsx return", contextvalues)
        }
        <Home />
